...
causas_morte <- read.csv("dados/deaths.csv")
...
# https://sparkbyexamples.com/r-programming/order-dataframe-by-one-descending-and-one-ascending-column-in-r/
...
# Renomeando as colunas do data frame 'top_5_causas' de acordo com o vetor 'name_vec' referências: https://cmdlinetips.com/2019/04/how-to-recode-a-column-with-dplyr-in-r/ https://stackoverflow.com/questions/60131993/rename-columns-based-on-vector
top_5_causas <- top_5_causas %>%
  mutate(Causa = recode(Causa, !!!name_vec))


# Cria um gráfico de barras horizontais
# https://mode.com/example-gallery/r_horizontal_bar/
